...
class Hospital(Base):
    ...
    data_issues = relationship("DataIssue", back_populates="hospital")
    ...
    ai_configs = relationship("AIConfig", back_populates="hospital")
    classification_tasks = relationship("ClassificationTask", back_populates="hospital")
    classification_plans = relationship("ClassificationPlan", back_populates="hospital")
    cost_benchmarks = relationship("CostBenchmark", back_populates="hospital")
    cost_values = relationship("CostValue", back_populates="hospital")

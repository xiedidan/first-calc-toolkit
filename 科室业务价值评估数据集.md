...
| 17 | 业务类别 | business_type | VARCHAR | 20 | 是 | - | 医疗业务类别：门诊、住院 |
| 18 | 患者ID | patient_id | VARCHAR | 50 | 否 | - | 患者唯一标识 |
| 19 | 就诊类型 | visit_type | VARCHAR | 20 | 是 | - | 门诊、急诊、住院等 |
| 20 | 就诊ID | visit_id | VARCHAR | 50 | 否 | - | 本次就诊的唯一标识 |
...
| 5 | 出院人次数 | discharge_count | INTEGER | - | 是 | 0 | 当月出院患者人次 |
| 6 | 出院人次数（非死亡病例） | discharge_count | INTEGER | - | 是 | 0 | 当月非死亡病例出院患者人次 |
| 7 | 特级护理床日数 | special_nursing_days | INTEGER | - | 否 | 0 | 特级护理总床日数 |
| 8 | 一级护理床日数 | level1_nursing_days | INTEGER | - | 否 | 0 | 一级护理总床日数 |
| 9 | 二级护理床日数 | level2_nursing_days | INTEGER | - | 否 | 0 | 二级护理总床日数 |
| 10 | 三级护理床日数 | level3_nursing_days | INTEGER | - | 否 | 0 | 三级护理总床日数 |
| 11 | 特殊疾病护理床日数 | special_disease_nursing_days | INTEGER | - | 否 | 0 | 特殊疾病护理总床日数 |
| 12 | 新生儿护理床日数 | newborn_nursing_days | INTEGER | - | 否 | 0 | 新生儿护理总床日数 |
| 13 | 重症监护床日数 | icu_days | INTEGER | - | 否 | 0 | ICU/重症监护总床日数 |
| 14 | 门急诊留观数 | emergency_observation_count | INTEGER | - | 否 | 0 | 门急诊留观患者人次 |
| 15 | 会诊发起数 | consultation_initiated_count | INTEGER | - | 否 | 0 | 作为申请方发起的会诊次数 |
| 16 | 会诊参与数 | consultation_participated_count | INTEGER | - | 否 | 0 | 作为受邀方参与的会诊次数 |
| 17 | MDT发起数 | mdt_initiated_count | INTEGER | - | 否 | 0 | 发起的MDT讨论次数 |
| 18 | MDT参加数 | mdt_participated_count | INTEGER | - | 否 | 0 | 参加的MDT讨论次数 |
...
| V1.1 | 2025-11-21 | 谢地 | 收费明细表增加业务类别字段 |
| V1.2 | 2026-01-07 | 谢地 | 调整病人唯一识别号和住院号相关的数据要求 |
